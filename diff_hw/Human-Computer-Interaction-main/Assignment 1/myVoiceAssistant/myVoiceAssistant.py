...
class myWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    # say hello or double click to wake up the assistant
    def wakeUp(self):
    ...
    '''
    提示语音识别失败
    若是sleeping状态，0.1s后再执行sleep状态函数
    若是waked but no command，继续执行WakedUpSuccess函数
    '''
